...
class RingraziamentiApp(tk.Tk):
    def __init__(self):
        ...
        # Dimensioni: larghezza fissa, altezza = schermo intero
    ...
    # ── UI principale ─────────────────────────────────────────────────────────
    def _build_ui(self):
        # Frame radice che occupa tutta la finestra
        ...
        # ── Bottone Lettore ───────────────────────────────────────────────────
        reader_outer = tk.Frame(root_frame, bg=BG)
        reader_outer.pack(fill="x", pady=(0, 20))
    ...
    def _switch_mode(self):
        ...
        # Rimuove il focus da qualsiasi Entry, spostandolo sulla finestra
        self.focus_set()
    ...
    def _reset_entry(self, entry: tk.Entry, placeholder: str, show):
        """Riporta l'Entry allo stato placeholder, azzerando il contenuto."""
        entry.config(show="")
        entry.delete(0, "end")
