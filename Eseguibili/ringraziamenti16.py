...
class RingraziamentiApp(tk.Tk):
    ...
    def _do_login(self, email: str, pwd: str):
        ...
        try:
            ...
            self.after(0, self._login_success, nome)
    ...
    def _login_success(self, nome: str):
        self.btn_main.config(state="normal")
        self.lbl_msg.config(text="")
        self.withdraw()
        WriterWindow(self, nome_scrittore=nome)
...
class ReaderWindow(tk.Toplevel):
    ...
    def _on_confirm(self):
        ...
        destinatario = "Luca Bianchi"  # TODO: ricavare dal database
        testo_esempio = (
